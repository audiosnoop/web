...
var __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;!(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__, exports, __webpack_require__(2), __webpack_require__(6)], __WEBPACK_AMD_DEFINE_RESULT__ = (function (require, exports, array_1, location_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    var r = /^\//, $global = window['global'] = {};
    function $init(path, search) {
        if (path === void 0) { path = location.pathname; }
        if (search === void 0) { search = location.search; }
        var body = document.body, query = $global.query = location_1.Search.toObject(search), input = document.getElementById('search-input');
        if (path) {
            array_1._forEach(body.querySelectorAll('[data-url]'), function (t) {
 ...
 */
!(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__, exports, __webpack_require__(3), __webpack_require__(1)], __WEBPACK_AMD_DEFINE_RESULT__ = (function (require, exports, core_1, access_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
...
var __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;!(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__, exports, __webpack_require__(5)], __WEBPACK_AMD_DEFINE_RESULT__ = (function (require, exports, navInit_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    navInit_1.$init();
}).apply(exports, __WEBPACK_AMD_DEFINE_ARRAY__),
