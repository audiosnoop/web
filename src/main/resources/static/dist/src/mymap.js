...
var __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;!(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__, exports, __webpack_require__(7), __webpack_require__(3), __webpack_require__(17), __webpack_require__(13), __webpack_require__(2), __webpack_require__(19)], __WEBPACK_AMD_DEFINE_RESULT__ = (function (require, exports, html_1, core_1, events_1, arrays_1, array_1, Forms_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    var ItemForm = /** @class */ (function () {
        function ItemForm(element) {
            ...
            this.$form = Forms_1.Forms.createForms(element);
            this.headerElement = element.querySelector('.header');
            propertyMap(element, 'click', this);
        }
        ItemForm.prototype.on = function (group, item) {
            console.log(item);
        ...
        ItemForm.prototype.$off = function () {
            this.element.parentElement.removeChild(this.element);
            return this;
        };
        ItemForm.prototype.$commit = function () {
            var _a = this, group = _a.group, item = _a.item, values = this.$form.values();
            if (item) {
                item.setData(values);
                group.render();
            }
    ...
    var $itemTemplate = compile(document.getElementById('item-template').innerText), $disassem = {
        datetime: function (d, self) {
            if (typeof d === 'number')
                self.datetime = new Date(d);
    ...
    var AudioGroup = /** @class */ (function () {
        function AudioGroup(element) {
            this.element = element;
            this.items = [];
            var nameEle = element.querySelector('[data-name]');
            this.key = nameEle.getAttribute('data-name');
            this.name = nameEle.textContent;
            this.container = element.querySelector('.list-groups');
            propertyMap(element, 'click', this);
        }
        AudioGroup.prototype.$add = function () {
            $itemForm.on(this);
        };
        AudioGroup.prototype.$modify = function (_a) {
            var id = _a.id;
            $itemForm.on(this, this.items[id]);
        };
        AudioGroup.prototype.$remove = function (_a) {
            var id = _a.id;
            this.removeItem(id).render();
            return this;
        };
        AudioGroup.prototype.addItem = function (item) {
            var items = this.items;
            if (items.indexOf(item) === -1)
                items.push(item);
            return this;
        };
        AudioGroup.prototype.removeItem = function (item) {
            var items = this.items;
        ...
        AudioGroup.prototype.render = function () {
            this.container.innerHTML = arrays_1.Arrays.slice(this.items, 6, function (v, i) {
                return '<div class="row">' + v.map(function (a, ii) { return $itemTemplate({
                    item: a, index: ii * (i + 1)
                }); }).join('') + '</div>';
            }).join('');
            return this;
    ...
    var AudioItem = /** @class */ (function () {
        function AudioItem(data) {
            this.datetime = new Date();
            data && this.setData(data);
        }
        AudioItem.prototype.setData = function (data) {
            core_1.$extend(this, data, $disassem);
            return this;
        };
        return AudioItem;
    }());
    selectAll(document.body, ['main', '.list-container[]'], function (body, main, cons) {
        array_1._forEach(cons, function (e) {
            var group = new AudioGroup(e);
            /*if (dummy[group.key]) {
...
!(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__, exports, __webpack_require__(18), __webpack_require__(13), __webpack_require__(3), __webpack_require__(1)], __WEBPACK_AMD_DEFINE_RESULT__ = (function (require, exports, NameMap_1, arrays_1, core_1, access_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
...
var __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;!(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__, exports, __webpack_require__(13)], __WEBPACK_AMD_DEFINE_RESULT__ = (function (require, exports, arrays_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
...
var __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;!(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__, exports, __webpack_require__(0), __webpack_require__(20), __webpack_require__(4), __webpack_require__(21), __webpack_require__(22)], __WEBPACK_AMD_DEFINE_RESULT__ = (function (require, exports, number_1, remap_1, datetime_1, inputs_1, calendar_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
